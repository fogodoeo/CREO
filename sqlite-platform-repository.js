...
const RECORD_TYPES = new Set(['vendor', 'item', 'shipment', 'setting', 'broadcast', 'asset', 'archive', 'capture', 'notification', 'checkoutchange']);
...
class SQLitePlatformRepository {
    ...
    async health() {
        return {
            ...
            adminConfigured: Boolean(this.adminSecret),
