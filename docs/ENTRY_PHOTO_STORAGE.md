...
후속 반영: 2026-09-12 `df3b479` 배포와 함께 비공개 버킷을 준비했다. 실제 운영 Linux 코덱·업로드·서명 조회·권한 거부·임시 파일 정리를 검증했다. [배포 기록](RELEASE_2026-09-12.md)을 참고한다. 아래 미배포 표기는 초기 구현 당시 기록이다.
