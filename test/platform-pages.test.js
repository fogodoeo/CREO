...
test('CREWARTS personality test uses minimal copy, Pretendard, and official share marks', () => {
    ...
    assert.match(script, /axisEvidence:\s*Object\.fromEntries/);
    assert.match(script, /resultAxisEvidence\[axisResult\.axis\]/);
    assert.match(script, /hasEvidence \? `<section class="cw-analysis-evidence">/);
