...
test('CREWARTS personality test uses minimal copy, Pretendard, and official share marks', () => {
    ...
    assert.match(html, /crewart-survey\.js\?v=20260815-calm-story-v24/);
    ...
    assert.match(script, /const mbtiProgress = segment\(progress, \.22, \.27\)/);
    ...
    assert.match(html, /crewart-survey-core\.js\?v=20260815-calm-story-v24/);
    assert.match(html, /crewart-survey-v4\.css\?v=20260815-calm-story-v24/);
