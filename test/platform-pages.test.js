...
test('CREWARTS personality test uses minimal copy, Pretendard, and official share marks', () => {
    ...
    assert.match(html, /crewart-survey\.js\?v=20260815-scroll-cue-v49/);
    ...
    assert.match(html, /crewart-survey-core\.js\?v=20260815-scroll-cue-v49/);
    assert.match(html, /crewart-survey-v4\.css\?v=20260815-scroll-cue-v49/);
