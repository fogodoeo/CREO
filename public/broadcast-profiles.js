(function (root, factory) {
    ...
    register({ id: 'basic-dice', engine: 'platform', brandMark: 'B', studioAccent: '#f4b544', studioAccentInk: '#241602', sharedStudio: true, page3Renderer: 'dice-teams', page3Label: '홀짝 기여도', page3Slots: ['teamContribution', 'dice'], page3SettingsSections: ['scoreboard', 'dice'], settings: { compatibilityModes: false, assets: true, diceAssets: true, page2Price: false, soldEffectPage: 3 }, defaultState: { page2PriceOn: false, page2SoldOn: false, page3On: true, scoreboardId: 'team-contribution', notice: 'BASIC LIVE', noticeDetail: '홀팀 VS 짝팀', page1Ticker: 'BASIC LIVE', page2Ticker: '실시간 경매', page3Title: '홀팀 VS 짝팀' } });
